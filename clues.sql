...
WHERE c.name = 'Holy See (Vatican City State)' AND cl.isofficial = 'T';
...
AND ci.name LIKE 'Serr%'
AND ci.name NOT LIKE '%valle';
...
-- Guess: Carmen Sandiego is heading to Santa Monica, United States.